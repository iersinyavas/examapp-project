...
public class AnalyticalGeometry extends DigitalSubject implements UnTestable {
	...
	public int questionQuantity() {
		return QuestionQuantity.ANALYTICAL_GEOMETRY_QUESTION_QUANTITY_2;
	}
	...
	public String getSubjectName() {
		return SubjectNameKey.ANALYTICAL_GEOMETRY;
	}
	
	@Override
	public String getSubjectAnswerKey() {
		return SubjectAnswerKey.KEY_A_ANALYTICAL_GEOMETRY;
	}

	@Override
	public String getSubjectQuestionKey() {
		return SubjectQuestionKey.KEY_Q_ANALYTICAL_GEOMETRY;
	}

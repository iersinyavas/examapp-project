...
public class Geography extends VerbalSubject implements Testable, AytTestEqualFocusCoefficient, AytTestVerbalCoefficient{
	...
	public float subjectEqualFocusCoefficient() {
		return Coefficient.GEOGRAPHY_EQUAL_FOCUS_COEFFICIENT_2_1;
	}

	@Override
	public float subjectVerbalCoefficientOne() {
		return Coefficient.GEOGRAPHY_VERBAL_COEFFICIENT_2_1;
	}

	@Override
	public float subjectVerbalCoefficientTwo() {
		return Coefficient.GEOGRAPHY_VERBAL_COEFFICIENT_2_2;
	}
	
	@Override
	public int getQuestionQuantity2() {
		return QuestionQuantity.GEOGRAPHY_QUESTION_QUANTITY_2_2;
	}
	
	@Override
	public int getQuestionQuantity() {
		return QuestionQuantity.GEOGRAPHY_QUESTION_QUANTITY_2_1;
	}

...
public class TytScore implements Score{

	private Testable testable;

	@Override
	public float scoreCalculate(Testable testable) {
		System.out.println(testable.getSubjectName() + ": " +netCalculate(testable)*testable.tytTestCoefficient().tytCoefficientOne());
		return netCalculate(testable) * testable.tytTestCoefficient().tytCoefficientOne();
	}
	...
	public String scoreName() {
		return SubjectNameKey.TYT_SCORE_NAME;
	}

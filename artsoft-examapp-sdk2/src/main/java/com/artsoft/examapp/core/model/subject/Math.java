...
public class Math extends DigitalSubject implements Testable, TytTestCoefficient, AytTestDigitalCoefficient, AytTestEqualFocusCoefficient{
	...
	public float tytCoefficientOne() {
		return Coefficient.MATH_COEFFICIENT_1;
	}

	@Override
	public float tytCoefficientTwo() {
		return Coefficient.MATH_COEFFICIENT_2;
	}

	@Override
	public float subjectDigitalCoefficient() {
		return Coefficient.MATH_DIGITAL_COEFFICIENT_2;
	}

	@Override
	public float subjectEqualFocusCoefficient() {
		return Coefficient.MATH_EQUAL_FOCUS_COEFFICIENT_2;
	}

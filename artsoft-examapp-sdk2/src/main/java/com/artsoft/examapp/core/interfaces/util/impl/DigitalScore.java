...
public class DigitalScore implements Score {
	...
	public float scoreCalculate(Testable testable) {
		System.out.println(testable.getSubjectName() + ": " +netCalculate(testable)*testable.aytTestDigitalCoefficient().subjectDigitalCoefficient());
		return netCalculate(testable) * testable.aytTestDigitalCoefficient().subjectDigitalCoefficient();
	}
	...
	public String scoreName() {
		return SubjectNameKey.DIGITAL_SCORE_NAME;
	}

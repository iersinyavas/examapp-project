...
public class Philosophy extends VerbalSubject implements Testable, AytTestVerbalCoefficient{
	...
	public int getQuestionQuantity() {
		return QuestionQuantity.PHILOSOPHY_QUESTION_QUANTITY_2;
	}
	...
	public float subjectVerbalCoefficientOne() {
		return Coefficient.PHILOSOPHY_VERBAL_COEFFICIENT_2;
	}

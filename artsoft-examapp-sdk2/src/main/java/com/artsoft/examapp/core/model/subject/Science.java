...
public class Science extends DigitalSubject implements Testable, TytTestCoefficient{
	...
	public int getQuestionQuantity() {
		return QuestionQuantity.SCIENCE_QUESTION_QUANTITY_1;
	}
	...
	public float tytCoefficientOne() {
		return Coefficient.SCIENCE_COEFFICIENT_1;
	}

	@Override
	public float tytCoefficientTwo() {
		return Coefficient.SCIENCE_COEFFICIENT_2;
	}

...
public class Turkish extends VerbalSubject implements Testable, TytTestCoefficient{
	...
	public float tytCoefficientOne() {
		return Coefficient.TURKISH_COEFFICIENT_1;
	}

	@Override
	public float tytCoefficientTwo() {
		return Coefficient.TURKISH_COEFFICIENT_2;
	}
